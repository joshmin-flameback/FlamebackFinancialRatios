...
RATIO_FIELD_DEPENDENCIES = {
    ...
    'get_altman_z_score': {'Total Current Assets', 'Total Current Liabilities', 'Total Assets', 'EBIT',
                           'Diluted Shares Outstanding', 'Revenue', 'Total Liabilities',
    ...
    'collect_financial_health_ratios': {'Total Debt', 'Total Equity', 'EBITDA', 'Interest Expense',
                                        ...
                                        'Diluted Shares Outstanding', 'Total Liabilities',
                                        'Retained Earnings', 'Stock Price'},

    # Earnings Ratios
    'get_piotroski_score_ratio': {'Net Income', 'Operating Cash Flow', 'Total Assets', 'Long Term Debt',
                                 'Current Assets', 'Current Liabilities', 'Shares Outstanding', 'Gross Margin',
                                 'Total Assets Turnover'},
    'get_revenue_growth_ratio': {'Revenue'},
    'get_eps_growth_ratio': {'Basic EPS'},
    'get_ebitda_margin_ratio': {'EBITDA', 'Revenue'},
    'get_roe_ratio': {'Net Income', 'Total Assets', 'Total Liabilities'},
    ...
    'get_roe_vs_average_roe_ratio': {'Net Income', 'Total Assets', 'Total Liabilities'},
    ...
    'collect_earning_ratios': {'Revenue', 'Basic EPS', 'EBITDA', 'Net Income',
                               'Total Assets', 'Total Liabilities', 'Free Cash Flow', 'Operating Cash Flow',
    ...
    # Quality Ratios
    'get_profit_dip_ratio': {'Revenue', 'Total Expense'},
    'get_roic_band_ratio': {'EBIT', 'Tax Rate', 'Total Equity', 'Short Term_Debt', 'Long Term Debt'},
    'get_aicr_ratio': {'Operating Cash_Flow', 'Capital Expenditure'},
    'collect_quality_ratios': {'Revenue', 'Total Expense', 'EBIT', 'Tax Rate', 'Total Equity', 
                               'Short Term_Debt', 'Long Term Debt', 'Operating Cash_Flow', 
                               'Capital Expenditure'},
    ...
    'get_cmp_cfo_band_ratio': {'Stock Price', 'Operating Cash_Flow', 'Shares Outstanding'},
    'get_fcf_yield_ratio': {'Operating Cash_Flow', 'Capital Expenditure', 'Stock Price', 'Shares Outstanding'},
    'collect_valuation_ratios': {'Basic EPS', 'WACC', 'Stock Price', 'Net Income', 'Total Assets', 
                                'Total Liabilities', 'Revenue', 'Operating Cash_Flow', 
                                'Capital Expenditure', 'Shares Outstanding'},
}
